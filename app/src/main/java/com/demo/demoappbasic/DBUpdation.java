...
public class DBUpdation {
    ...
    public static void tableUpgrade(SQLiteDatabase db, String sTblNm, String newTblSctipt){
        ...
        try{
            ...
            String insertScript = "INSERT OR REPLACE INTO "+ sTblNm +" ("+getColumns(db,"temp_"+sTblNm)+") SELECT "+ getColumns(db,"temp_"+sTblNm)  +" FROM temp_"+sTblNm+"";
    ...
    private static String getColumns(SQLiteDatabase db, String TblNm) {
        ...
        {
//			if(TblNm.equalsIgnoreCase("temp_accmst")&& columnNames[i].equalsIgnoreCase("type")){
//				scol += "varAcType" +",";
//			}else{
            scol += columnNames[i] +",";
//			}
